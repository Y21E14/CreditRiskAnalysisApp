...
/**
 * UEN is the business identifier code (ISO 9362). This UEN check is not a guarantee for authenticity.
 *
 * UEN pattern: BBBBCCLLbbb (8 or 11 characters long; bbb is optional)
 *
 * Validation is case-insensitive. Please make sure to normalize input yourself.
 *
 * UEN definition in detail:
 ...
 */
$.validator.addMethod( "uen", function( value, element ) {
    return this.optional( element ) || /^([A-Z]{6}[A-Z2-9][A-NP-Z1-9])(X{3}|[A-WY-Z0-9][A-Z0-9]{2})?$/.test( value.toUpperCase() );
}, "Please specify a valid UEN code." );
